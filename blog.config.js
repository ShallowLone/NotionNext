...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Shallowlone', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Time like these', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.shallowlone.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Aqua Blue', // 网站关键词 英文逗号隔开
